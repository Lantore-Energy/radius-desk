...
mkdir  -p ~/radius-desk/volume
mkdir  -p ~/radius-desk/volume/db_startup
mkdir  -p ~/radius-desk/volume/db_conf
chmod -R 777 ~/radius-desk/volume
chmod -R 777 ~/radius-desk/volume/db_startup
chmod -R 777 ~/radius-desk/volume/db_conf
